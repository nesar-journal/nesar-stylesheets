...
\setmainfont[Numbers={Proportional,Lining},SmallCapsFont={Adobe Caslon Pro},SmallCapsFeatures={Letters=SmallCaps,Numbers=OldStyle}]{Adobe Caslon Pro}
...
\newcommand{\Nyear}{\trim{\input{metadata-year.tex}}}
\newcommand{\Nauthor}{\trim{\input{metadata-author-full.tex}}}
\newcommand{\Ntitle}{\trim{\input{metadata-title.tex}}}
\newcommand{\article}{\trim{\input{metadata-article.tex}}}
\newcommand{\issue}{\trim{\input{metadata-issue.tex}}}
...
\newcommand\sectionsecnumformat{\oldstylenums{\thesection.\ }}

\newcommand\onpage{\addfontfeature{Numbers={Proportional,OldStyle}}\thepage}
\usepackage{etoolbox}
\makeatletter
...
\setsecheadstyle{\centering\LARGE\scshape\MakeLowercase}
\setsubsecheadstyle{\centering\large\scshape\MakeLowercase}
...
\newcommand{\shauthor}{\input{metadata-author-short}}
...
\usepackage{wrapfig}
\usepackage{enumitem}
\setlist[itemize]{labelindent=\parindent,itemsep=0.15em,topsep=0pt,leftmargin=\parindent,label={\tiny\fontspec{Printers Ornaments One}e}}
...
\input{component-infopage}
\setcounter{page}{0}
\clearpage

\begin{center}{\noindent\huge{\thetitle}}\bigskip\bigskip

\input{metadata-author-list}
\end{center}
