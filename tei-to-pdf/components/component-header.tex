...
\makeatother
\newcommand{\oldnums}[1]{{\fontspec[Numbers={Proportional,OldStyle}]{TeX Gyre Termes}#1}}
\newcommand{\oldnumsbold}[1]{{\fontspec[Numbers={Proportional,OldStyle}]{TeX Gyre Termes}\textbf{#1}}}
...
%      }%
    ...
    \begin{tikzpicture}[remember picture, overlay]
      ...
      \node[inner sep=0pt] (titlebox) at ([yshift=0.55cm]backgroundimage.north) {\begin{titlebox}\begin{center}\vspace{2ex}%
          ...
          \IfFileExists{metadata/metadata-translator-full.tex}{%
            \vspace{0.5ex}{\large translated by \input{metadata/metadata-translator-full.tex}\par}%
          }{}%
          \vspace{2ex}
...
\newtcolorbox{mediabox}{
    enhanced,
    boxrule=0.5pt,
    colframe=Nesarlinkdark,
    colback=Nesarlinklight,
    sharp corners,
    halign=center,
    fontupper=\rmfamily,
...
\widowpenalty10000
\clubpenalty10000
\parfillskip=0pt plus 0.5\hsize
